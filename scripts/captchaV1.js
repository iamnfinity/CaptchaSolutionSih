    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body" style="background-color: black;">
          <div class="row h-100">
            <div class="col-12 my-auto" style="padding: 0px;">
                <h1 class="text-center" id="result" style="color: #9786ac;">Captcha System</h1>
                <p class="text-center">This will collect <b style="color: #9786ac;">100</b> data points and Send to Server
                </p>
                <p id="success" class="text-center">Keep Drawing Untill You See <span style="color: green;">Success</span>
                    Message</p>
                <p class="text-center" style="color: #9786ac;">V 1.0 </p>
            </div>
            <canvas id="draw" class="disable-touch" style="width: auto; position: absolute; z-index:10 ;"></canvas>
          </div>
        </div>
    ...
    function sendData(dataX, dataY, timeStamps) {
        ...
        jQuery.ajax({
            ...
            beforeSend: function (x) {
                $("#success").text("Sending Data....")
            },
            success: function (result) {
                console.log("Result Block");
                $("#success").text(result.score);
                if (result.isBot) {
                    $("#result").text("Bot Detected");
                } else {
                    $("#" + modalName).modal('hide');
                    console.log(formIDGlobal);
                    bootstrap.isVerified = true;
                    $(formIDGlobal).submit();
                }
            }
        });
